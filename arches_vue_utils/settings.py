"""
Django settings for arches_vue_utils project.
"""
...
DATATYPE_LOCATIONS.append("arches_vue_utils.datatypes")
FUNCTION_LOCATIONS.append("arches_vue_utils.functions")
ETL_MODULE_LOCATIONS.append("arches_vue_utils.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_vue_utils.search_components")
...
SECRET_KEY = "django-insecure-ak-a8(i7%dh=0(t5wr#knc0a_z=vjdbg*k5)v5gx_nd^ajgx)l"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_vue_utils.urls"
ROOT_HOSTCONF = "arches_vue_utils.hosts"

DEFAULT_HOST = "arches_vue_utils"
...
ELASTICSEARCH_PREFIX = "arches_vue_utils"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_vue_utils.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_vue_utils",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_vue_utils.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_vue_utils"
